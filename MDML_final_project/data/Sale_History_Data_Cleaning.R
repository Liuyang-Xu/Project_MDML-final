...
write.csv(sale_history_account_test_1, "C:\\Users\\stigg\\OneDrive\\Desktop\\(2022 Spring)\\Machine Learning\\Homework\\Final Project\\sale_history_account_test_1.csv",row.names=FALSE)
